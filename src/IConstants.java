...
interface IConstants {
    ...
    final String NEWLOGIN_COMMAND = "newlogin";
    final String DELLOGIN_COMMAND = "dellogin";
    final String CHANGEPAS_COMMAND = "changepas";
    final String PRINTBAS_COMMAND = "printbas";
    final String SERVKAJ_KAJ = "Server kajuk";
    final String EXIT_COMMAND_CL = "/s exit";
}